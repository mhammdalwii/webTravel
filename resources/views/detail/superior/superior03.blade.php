    ...
    <div class="container py-5">
                ...
                <div id="carouselExampleIndicators" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/images/detail/superior03/1.jpg" class="d-block w-100 img-carousel"
                                alt="kapal1">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/superior03/2.jpg" class="d-block w-100 img-carousel"
                                alt="kapal3">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/superior03/3.jpg" class="d-block w-100 img-carousel"
                                alt="kapal4">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/superior03/4.jpg" class="d-block w-100 img-carousel"
                                alt="kapal5">
                        </div>
                    </div>
        ...
        <section>
            ...
            <div class="col-md-12 mt-3 ">
                ...
                <p>The <strong>Superior 03</strong> boat is a Superior category phinisi. Has 6 cabins for a total of 15
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/superior03/5.jpg" class="card-img-top rounded"
                                    alt="Master Cabin" style="object-fit: cover;">
                            </div>
                            <div class="card-body text-center">
                                <h6 class="fw-bold">Master Cabin</h6>
                                <p class="mb-1 text-muted">2-4 Guest</p>
                                <p class="fw-semibold text-dark">Rp 4.400.000 / Guest</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/superior03/6.jpg" class="card-img-top rounded"
                                    alt="Private Cabin" style="object-fit: cover;">
                            </div>
                            <div class="card-body text-center">
                                <h6 class="fw-bold"> Full Ocean Cabin</h6>
                                <p class="mb-1 text-muted">2-4 Guest</p>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/superior03/7.jpg" class="card-img-top" alt="sharingCabin"
