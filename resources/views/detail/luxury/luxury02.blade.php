                ...
                <div id="carouselExampleIndicators" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/images/detail/luxury02/1.jpg" class="d-block w-100 img-carousel" alt="kapal1">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/luxury02/2.jpg" class="d-block w-100 img-carousel" alt="kapal3">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/luxury02/3.jpg" class="d-block w-100 img-carousel" alt="kapal4">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/luxury02/4.jpg" class="d-block w-100 img-carousel" alt="kapal5">
                        </div>
                    </div>
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/luxury02/5.jpg" class="card-img-top rounded" alt="Master Cabin"
                                    style="object-fit: cover;">
                            </div>
                            <div class="card-body text-center">
                                <h6 class="fw-bold">Santulum Cabin I</h6>
                                <p class="mb-1 text-muted">2-4 Guest</p>
                                <p class="fw-semibold text-dark">Rp 10.500.000 / Guest</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm">
                            ...
                            <div class="card-body text-center">
                                <h6 class="fw-bold"> Santulum Cabin II</h6>
                                <p class="mb-1 text-muted">2 Guest</p>
                                <p class="fw-semibold text-dark">Rp 10.000.000 / Guest</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/luxury02/8.jpeg" class="card-img-top" alt="sharingCabin"
                                    style="object-fit: cover;">
                            </div>
                            <div class="card-body text-center">
                                <h6 class="fw-bold"> 2 Cafasa Cabin</h6>
                                <p class="mb-1 text-muted"> 2 Guest</p>
                                <p class="fw-semibold text-dark">Rp 7.250.000 / Guest</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/luxury02/9.jpg" class="card-img-top" alt="sharingCabin"
                                    style="object-fit: cover;">
                            </div>
                            <div class="card-body text-center">
                                <h6 class="fw-bold"> 2 Sharing Cabin</h6>
                                <p class="mb-1 text-muted"> 2 Guest</p>
                                <p class="fw-semibold text-dark">Rp 5.250.000 / Guest</p>
                            </div>
                        </div>
                    </div>
                </div>
