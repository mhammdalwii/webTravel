                ...
                <div id="carouselExampleIndicators" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/images/detail/luxury01/1.jpg" class="d-block w-100 img-carousel" alt="kapal1">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/luxury01/2.jpg" class="d-block w-100 img-carousel" alt="kapal3">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/luxury01/3.jpg" class="d-block w-100 img-carousel" alt="kapal4">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/luxury01/4.jpg" class="d-block w-100 img-carousel" alt="kapal5">
                        </div>
                    </div>
            ...
            <div class="col-md-12 mt-3 ">
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/luxury01/5.jpg" class="card-img-top rounded" alt="Master Cabin"
                                    style="object-fit: cover;">
                            </div>
                            <div class="card-body text-center">
                                <h6 class="fw-bold">Master Cabin</h6>
                                <p class="mb-1 text-muted">2-3 Guest</p>
                                <p class="fw-semibold text-dark">Rp 8.250.000 / Guest</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/luxury01/6.jpg" class="card-img-top rounded"
                                    alt="Private Cabin" style="object-fit: cover;">
                            </div>
                            <div class="card-body text-center">
                                <h6 class="fw-bold"> 2 Deluxe Cabin</h6>
                                <p class="mb-1 text-muted">2 Guest</p>
                                <p class="fw-semibold text-dark">Rp 6.950.000/ Guest</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="mb-1 text-muted"> 3/4 Guest</p>
                                <p class="fw-semibold text-dark">Rp 4.950.000 / Guest</p>
                            </div>
                        </div>
                    </div>
                </div>
