                ...
                <div id="carouselExampleIndicators" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/images/detail/deluxe02/1.png" class="d-block w-100 img-carousel" alt="kapal1">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/deluxe02/2.JPG" class="d-block w-100 img-carousel" alt="kapal3">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/deluxe02/3.jpg" class="d-block w-100 img-carousel" alt="kapal4">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/deluxe02/4.jpg" class="d-block w-100 img-carousel" alt="kapal5">
                        </div>
                    </div>
            ...
            <div class="col-md-12 mt-3 ">
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/deluxe02/5.jpg" class="card-img-top rounded" alt="Master Cabin"
                                    style="object-fit: cover;">
                            </div>
                            <div class="card-body text-center">
                                <h6 class="fw-bold">Honeymoon Cabin</h6>
                                <p class="mb-1 text-muted">2 Guest</p>
                                <p class="fw-semibold text-dark">Rp 4.450.000 / Guest</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/deluxe02/6.jpg" class="card-img-top rounded"
                                    alt="Private Cabin" style="object-fit: cover;">
                            </div>
                            <div class="card-body text-center">
                                <h6 class="fw-bold"> 2 Private Cabin</h6>
                                <p class="mb-1 text-muted">2 Guest</p>
                                <p class="fw-semibold text-dark">Rp 4.200.000 / Guest</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/deluxe02/7.jpg" class="card-img-top" alt="sharingCabin"
                                    style="object-fit: cover;">
                            </div>
                            <div class="card-body text-center">
                                <h6 class="fw-bold">3 Sharing Cabin</h6>
                                <p class="mb-1 text-muted"> 4-6 Guest</p>
                                <p class="fw-semibold text-dark">Rp 3.3600.000 / Guest</p>
                            </div>
                        </div>
                    </div>
                </div>
