                ...
                <div id="carouselExampleIndicators" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/images/detail/deluxe03/1.jpeg" class="d-block w-100 img-carousel" alt="kapal1">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/deluxe03/2.JPG" class="d-block w-100 img-carousel" alt="kapal3">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/deluxe03/3.JPG" class="d-block w-100 img-carousel" alt="kapal4">
                        </div>
                        <div class="carousel-item">
                            <img src="/images/detail/deluxe03/4.JPG" class="d-block w-100 img-carousel" alt="kapal5">
                        </div>
                    </div>
            ...
            <div class="col-md-12 mt-3 ">
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/deluxe03/5.JPG" class="card-img-top rounded" alt="Master Cabin"
                                    style="object-fit: cover;">
                            </div>
                            <div class="card-body text-center">
                                <h6 class="fw-bold">Master Cabin</h6>
                                <p class="mb-1 text-muted">2-4 Guest</p>
                                <p class="fw-semibold text-dark">Rp 5.500.000 / Guest</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/deluxe03/6.JPG" class="card-img-top rounded"
                                    alt="Private Cabin" style="object-fit: cover;">
                            </div>
                            <div class="card-body text-center">
                                <h6 class="fw-bold"> 2 Private Cabin</h6>
                                <p class="mb-1 text-muted">2 Guest</p>
                                <p class="fw-semibold text-dark">Rp 4.300.000 / Guest</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                            <div class="ratio ratio-4x3">
                                <img src="/images/detail/deluxe0/7.JPG" class="card-img-top" alt="sharingCabin"
                                    style="object-fit: cover;">
                            </div>
                            <div class="card-body text-center">
                                <h6 class="fw-bold"> Sharing Cabin</h6>
                                <p class="mb-1 text-muted"> 4 Guest</p>
                                <p class="fw-semibold text-dark">Rp 3.3900.000 / Guest</p>
                            </div>
                        </div>
                    </div>
                </div>
